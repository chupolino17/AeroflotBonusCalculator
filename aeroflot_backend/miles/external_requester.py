...
payload_query_template = '{"airline":{"airlineCode":"SU"},"origin":{"airport":{"airportCode":"AIRPORT_FROM"}},"destination":{"airport":{"airportCode":"AIRPORT_TO"}},"tierLevel":{"tierLevelCode":"basic"},"isRoundTrip":false,"lang":"ru"}'

def get_miles_payload(code_from, code_to):

    payload_query = payload_query_template
