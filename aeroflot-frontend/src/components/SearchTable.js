...
import { setNeedSearch, setTickets } from "../slices/searchSlice";
...
export function SearchTable(props) {
  ...
  const parseTickets = async(tickets) =>{
    ...
    console.log('TO VISUALIZE', tickets)
    console.log(`${API_SERVER}/search/search/`)

    console.log(segments_state)
